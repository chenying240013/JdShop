<%@ page language="java" import="java.util.*,com.vo.Jdproduct,com.page.PageInfo" pageEncoding="utf-8"%>
<%
		...
		<style type="text/css">
			* {
		    ...
		    .logo-a {
				...
				width: 276px;
				height: 50px;
				background: url(listImg/jdlogo-2018.png);
				display: block;
				position: relative;
				top: 18px;
			}
			...
			#hotsale .hd1 {
				...
				font-family: "微软雅黑";
				font-size: 14px;
				background: url(listImg/list.icons.other.png) no-repeat;
			}
			#hotsale .hd2 {
				width: 30px;
				height: 60px;
			...
			<div class="crumbs-bar clearfix">
				<div class="crumbs-nav">
					<div class="crumbs-nav-item one-level">
						<a class="crumbs-link" href="//shouji.jd.com">手机</a> <i class="crumbs-arrow">></i>
					</div>
					<div class="menu-drop">
						<div class="trigger">
		...
		<script type="text/javascript">
			$(function() {
				...
				$(".filter .f-sort a").mouseover(function() {
					...
					$(this).siblings(":not([class*='cur'])").find(":nth-child(2)").css("background-image", "url(listImg/arrow/grayDown.png)");
