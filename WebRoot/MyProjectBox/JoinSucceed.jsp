		...
		<style type = "text/css">
				@CHARSET "UTF-8";
									...
									.succeed-icon {
									    ...
									    background-image: url(../img/bc40d1e21831aea88c8379e0ae61a1bf_addtocart-icons.png);
		...
		<body>
			...
			<div class="logoBox">
				<div class="w">
					<div class="logoDog">
						<img
							src="img/bff8f7956d52a4ecf455ec5d2aead824_jdlogo-201708-@1x.png" />
					</div>
					<div class="SousuoBox">
					...
					<div class="ShopCar">
						<a href="CategoryServlet?action=getAll" class="myCar">我的购物车</a> <i class="icon1"></i> <i
							class="icon2">0</i>
					</div>
			...
			<!--全部商品分类end--> 
			<%
				Category2 category=(Category2)request.getAttribute("category2");
			%>
						...
						<div class = "aready-succeed">
								...
								<div class = "succeed-left-part2">
									<div class = "left-part2-img clearfix">
										...
										<div class = "left-part2-desc">
											<div class = "desc-name">
											<a href = "//item.jd.com/4896340.html"target = " _blank"><%=category.getCdesc() %></a>
											</div>
											<div class = "desc-info">
												<span class="txt" title="洁面【加量装150g】">颜色：洁面【加量装150g】</span>
												<span class="txt">/  数量：<%=category.getCsum() %></span>
											</div>
										</div>
									</div>
							...
							<div class = "succeed-right">
								...
								<div class = "lookAndquery">
									...
									<a class="btn-addtocart" href="CategoryServlet?action=getAll" id="GotoShoppingCart" clstag="pageclick|keycount|201601152|4">
								...
								<ul class = "needthings-ul">
										...
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/XiaoMiHu.jpg" alt="小迷糊 玻尿酸补水黑面膜套装21片（补水清洁 锁水保湿 男女士护肤化妆品）">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/FangShaiShuang.jpg" alt="妮维雅(NIVEA)冰爽透明防晒气雾200ml（防晒喷雾 户外SPF50 德国进口 男女护肤适用）">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/Fangshaishuang2.jpg" alt="【第二件5折】资生堂安热沙（Anessa）小金瓶安耐晒防晒霜防水防汗防晒喷雾 18年新款小金瓶60ml">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/ManXiuLei.jpg" alt="曼秀雷敦（Mentholatum）控油冰爽洁面泡沫150ml（绵密泡沫 清透毛孔 控油清爽 抑制油脂分泌 护肤男）">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/kouhong.jpg" alt="迪奥（Dior） 口红  女士唇膏 情人节七夕生日礼品礼盒礼物 烈艳蓝金999 烈艳蓝金365#[肉粉色]">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/Taohe.jpg" alt="【京东JOY联名款】兰芝(LANEIGE)水衡透润京东定制礼盒(水200+50ml+乳120+50ml+洁面50ml+面膜15ml)(护肤品)">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/zhijiayou.jpg" alt="MissCandy健康美甲 可撕拉指甲油 美甲套装  亮片脚指甲油  美甲钻饰香樟树MCS262">
												</a>
											</div>
											<div class = "needName">
									...
									<li class = "needthings-li">
										<div class = "needItem1" >
											<div class = "needImg">
												<a target="_blank" href="//item.jd.com/1862177.html">
													<img width="98" height="98" +="" src="img/manOu.jpg" alt="欧莱雅（LOREAL） 套装男士护肤品防晒霜水能保湿洗面奶爽肤水乳液 四件套洁面膏+水凝露+滋润乳+防晒保湿露">
												</a>
											</div>
											<div class = "needName">
