...
<body>
		...
		<div class="w">
			...
			<ul class="fr">
				<li class="fore1" id="ttbar-login"><a href=""
					class="link-login style-red">jd_1778353503...</a>&nbsp;&nbsp; <a
					href="../JD/JD_register.html" class="link-regist ">退出</a></li>
				<li class="spacer"></li>
				<li class="fore2">
					<div class="dt">
			...
			<div class="man_nameandadr">
				<div class="man_nameandadr_1">
					...
					<div class="man_nameandadr_1_2">
						<span>海雁茹</span> <span title="山东 济南市 长清区 大学科技园大学路一号山东师范大学长清校区"
							class="addr-info" limit="45">海雁茹 天津 西青区 全境 中北·天软创业学院</span> <span
							class="addr-tel"> 138****6812</span>
					</div>
				</div>
			</div>
			<!--推荐匹配自提点-->
									...
									<div class="goods-msg-gel">
										<div class="p-name">
											<a href="http://item.jd.com/3141248.html" target="_blank">
												古驰（GUCCI）罪爱女用淡香水 30ml（又名：古驰（GUCCI）罪爱女士淡香水 30ml ) </a>
										</div>
										<div class="p-price"
											style="position: relative;top:-11px;left: -1px;">
											<strong class="jd-price">￥499.00</strong> <span class="p-num">x1</span>
	...
	<div class="showMoney" style="margin-bottom: 10px;">
		<div class="list">
			<span><em class="ftx-01">1</em> 件商品，总商品金额：</span> <em class="price"
				id="warePriceId">￥499.00</em>
		</div>
	...
	<div class="tijiao">
		...
		<button id="" value="提交订单" class="tjbtn">
			<a href="tijiaodingdan.html">提交订单</a><b></b>
		</button>
	</div>
	<!-- 右边悬浮 -->
	<div class="w">
