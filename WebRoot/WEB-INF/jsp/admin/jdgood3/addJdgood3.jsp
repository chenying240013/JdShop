...
<body>
	...
	<form action="Jdgood3Servlet" method="post">
		...
		<fieldset id="categoryFieldset">
			<legend>添加三级商品种类</legend>
			<div class="categoryClass">
				<label for="j2name">商品种类名称</label><input type="text" class="categoryLabel" name="j3name"
					id="cname" />
			</div>
			...
			<div class="categoryClass">
				<input type="submit" class="btn btn-success addCategoryBtn" value="添加三级商品种类" />
			</div>
		</fieldset>
	</form>
