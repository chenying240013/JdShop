<%@ page language="java" import="java.util.*,com.vo.Jdgood" pageEncoding="UTF-8"%>
<%
...
<body>
	...
	<form action="JdgoodServlet" method="post">
		<input type="hidden" name="action" value="update"/>
		
		<%
			Jdgood jdgood = (Jdgood)request.getAttribute("jdgood");
		...
		<fieldset id="categoryFieldset">
			...
			<input type="hidden" name="jid" value="<%=jdgood.getJid()%>"/>
			<input type="hidden" name="requestPage" value="<%=requestPage%>"/>
			<div class="categoryClass">
				<label for="jname">商品种类名称</label><input type="text" class="jdgoodLabel" name="jname"
					id="cname" value="<%=jdgood.getJname()%>"/>
			</div>
