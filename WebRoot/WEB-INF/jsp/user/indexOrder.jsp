<%@ page language="java"
	import="java.util.*,com.vo.*,com.service.impl.*"
...
.item-fore1 {
	...
	text-align: 42px;
	color: #444;
	background: url(img3/ico_service.png) no-repeat;
}
...
.last-icno-bottom a.ac-1 {
	...
	background: url(img3/ico_footer.png);
}
...
.jd-app>a.jd-phone-1 {
	display: inline-block;
	background: url(img3/sprite_mobile@1x.png);
	width: 25px;
...
.myjd-car-icon b {
	...
	width: 56px;
	margin-top: 5px;
	background: url(img3/settleup-nogoods.png) no-repeat;
}
...
@font-face {
	...
	src: url('//at.alicdn.com/t/font_775422_afj9l7lz3fm.eot?#iefix')
		format('embedded-opentype'),
		url('//at.alicdn.com/t/font_775422_afj9l7lz3fm.woff') format('woff'),
		url('//at.alicdn.com/t/font_775422_afj9l7lz3fm.ttf')
		format('truetype'),
		url('//at.alicdn.com/t/font_775422_afj9l7lz3fm.svg#iconfont')
		format('svg');
}
...
<body>
	...
	<div class="box1">
		<div class="w">
			...
			<ul class="fl">
				<!--首页-->
				<li id="con-one"><i class="iconfont" id="icon-one">&#xe63d;</i>
					<a href="http:\\www.jd.com">京东首页</a></li>

				<!--地址-->
				<li id="icon-two">
					<div class="con-two">
						<i class="iconfont" id="icon-one-3">&#xe676;</i> <span
							id="text-beijing">北京 </span>
					</div>
					<div id="hide-city">
						...
						<span id="city-txt"> Available Sites </span>
						<!--底层的内容-->
						<ul id="city-ul">
							<li><a href="#">
									<div id="city-ul-icon-1">
										<img src="img3/city-txt-1.png" />
									</div>
									<div id="city-ul-txt">Global Site</div>
							</a></li>
							<li id="city-ul-2"><a href="#">
									<div id="city-ul-icon">
			...
			<ul class="fr">
				...
				<li class="fore3">
					<div class="dt2">
						<a href="#">我的京东</a> <i class="iconfont" id="icon-myjd">&#xe692;</i>
					</div> <!--我的京东js-->
					<div id="myjd-js">
						<div id="myjd-js-1">
							<div id="title">
				...
				<li class="fore5">
					<div class="dt4">
						<a href="#">企业采购</a> <i class="iconfont" id="icon-myjd">&#xe692;</i>
					</div> <!--企业采购js-->
					<div id="myjd-caigou">
				...
				<li class="fore6">
					<div class="dt5">
						<a href="#">客户服务</a> <i class="iconfont" id="icon-myjd">&#xe692;</i>
					</div> <!--客户服务js-->
					<div id="jdser">
						<div id="jdser-con">
							<div id="jdser-con-item">客户</div>
							<div id="jdser-con-title">
								<a href="">帮助中心</a>
							</div>
							<div id="jdser-con-title">
								<a href="">售后服务</a>
				...
				<li class="fore7">
					<div class="dt6">
						<a href="#">网站导航</a> <i class="iconfont" id="icon-myjd">&#xe692;</i>
					</div> <!--网站导航js-->
					<div id="web-nav">
						<div class="web-con">
							<dl class="web-dl1">
				...
				<li class="fore8">
					...
					<div class="jd-phone">
						<div class="jd-phone-con">
							<div class="jd-phone-title">
								...
								<div class="jd-phone-img">
									<img src="img3/59a51bf6Nb8e478cc.png" />
								</div>
								<div class="jd-phone-p">
									...
									<p class="jd-app">
										<a href="#" class="jd-phone-1"></a> <a href="#"
											class="jd-phone-2"></a> <a href="#" class="jd-phone-3"></a>
									</p>
								</div>
						...
						<div class="jd-phone-con">
							<div class="jd-phone-title">
								<div class="jd-phone-img">
									<img src="img3/5874a54dNcec29924.jpg" />
								</div>
								<div class="jd-phone-p">
									<h5 class="jd-phone-h">
										<a href="#">关注京东微信</a>
						...
						<div class="jd-phone-con-other">
							<div class="jd-phone-title">
								<div class="jd-phone-img">
									<img src="img3/5874a555Ne8192324.jpg" />
								</div>
								<div class="jd-phone-p">
									<h5 class="jd-phone-h">
										<a href="#">京东金融客户端</a>
									...
									<p class="jd-phone-val">新人专享大礼包</p>
									<p class="jd-app">
										<a href="#" class="jd-phone-2"></a> <a href="#"
											class="jd-phone-3"></a>
									</p>
								</div>
							</div>
	...
	<div class="myjd">
		<div class="w">
			...
			<div class="two_content fl">
				<div class="tl-icon">
					<a href="#" class="left-icon"></a> <a href="#" class="left-icon-1">我的京东</a>
					<a href="http:\\www.jd.com" class="left-icon-2">返回京东首页</a>
				</div>
				<!--中间内容-->
				<div class="middle-con">
					<ul>
						<li class="fore-1"><a href="www.jd.com">首页</a></li>
						<li class="fore-2">
							<div id="fore2_span">
								<span class="myjd_set">账户设置</span> <b></b>
							</div>
						...
						<li class="fore-4"><a href="#">消息</a></li>
					</ul>
				</div>
			</div>
			<div class="rt-cont fr">
				...
				<div id="icon">
					<div id="iconCar">
						...
						<a href="CategoryServlet?action=getAll" id="iconSpan">我的购物车</a> <i id="icon-Car-mag">1</i>
					</div>
					<!--购物车隐藏界面-->
					<div class="myjd-car">
						<div class="myjd-car-icon">
							<b></b> <span>购物车还没有商品，赶紧选购吧！</span>
						</div>
					</div>
				</div>
			</div>
			<div class="search">
				<input type="text" name="" id="search-1" value="" /> <input
					type="button" name="" id="search-2" value="搜素" />
			</div>
		</div>
	</div>
	<!--第三行-->
			...
			<div class="con-1">
				...
				<div class="con-title-two">
					<div class="con_two">
						<ul class="con_ul">
							<li class="con_li_1"><a
								href="IndexActionServlet?action=getAllOrder"> 全部订单 </a></li>
							<li class="con_li_2"><a
								href="IndexActionServlet?action=queryOrderState&ostate=0">待付款</a>
								<%
							...
							<li class="con_li_2">
								...
								<a href="IndexActionServlet?action=queryOrderState&ostate=1">待收货</a>
							</li>
							<li class="con_li_2"><a href="#"> 待评价 </a></li>
							<li class="con_li_5"><a href="#"> 我的常购商品 </a></li>
							<li class="con_li_6"><a href="#"> 好货·清仓 </a></li>
							<li class="con_li_7"><a href="#"> 订单回收站 </a></li>
						</ul>

						<form id="categoryForm"
							action="IndexActionServlet?action=getAllByQuery" method="post">
							<div class="con_Search">
								<div class="con_div_search">
									<input type="text" name="search_inp" id="search_inp"
										value="商品名称/商品编号/订单编号" />
								</div>
								<input type="submit" class="search-btn"> <b></b> </input> <a
									href="#" class="default-btn"> <i>高级</i> <b></b>
								</a>
							</div>
						</form>
					...
					<div class="main_mc">
						...
						<table class="order-tb">
							...
							Login user1 = (Login)session.getAttribute("user");
								List<CategoryOrder> list = (List<CategoryOrder>) request.getAttribute("list");
								List<Jdproduct> sessionlist = (List<Jdproduct>) session.getAttribute("shoppingCart");
								int Psum =0;
								if (list != null) {
									for (CategoryOrder order : list) {
										for (Jdproduct category : sessionlist) {
											int price = Integer.category.getPrice();
											int Csum= category.getProductSum();
											Psum = price * Csum;
							...
							<tbody>
								...
								<tr class="tr-th">
									<td colspan="5"><span class="gap"></span> <span
										class="detime"><%=order.getOtime()%></span> <span
										class="number"> 订单号：<%=order.getOid()%> <a href="#"></a>
									</span>
										<div class="tr-operate">
											<span class="order-shop"> <a href="#">北京</a> <a
												href="#"></a>
											</span>
										</div></td>
								</tr>
								...
								<tr class="tr-td">
									<td>
										<div class="goods-item">
											<div class="p-img">
												<a href="#"> <img src="img3/5b7e8a4dN553ac18a.jpg" />
												</a>
											</div>
											<div class="p-msg">
												<div class="p-name">
													<a href="#"><%=category.getPname()%></a>
												</div>
												<div class="p-next">
													<a href="">找相似</a>
												</div>
										...
										<div class="goods-number">
											x<%=category.getProductSum()%>
										</div>
										<div class="goods-repair"></div>
									</td>
									<td colspan="1">
										<div class="con-top">
											<span class="txt"><%=user1.getUsername() %></span> <b></b>
										</div>
									</td>
									<td rowspan="1">
										<div class="amount">
											<span style="color: #aaa; font-size: 12px;">总额<%=Psum %></span> <br>
											<strong>应付</strong> <br> <strong>¥<%=Psum%></strong>
									...
									<td rowspan="1">
										...
										if(state==0){
											%>
											<span class="status-price">等待付款</span>
											<% 
										}else{
											%>
											<span class="status-price">等待收货</span>
										<% 
										}
										%>
									...
									<td rowspan="1">
										<div class="operate">
											...
											<a href="Javascript:void(0);" onclick="payMentOneById(<%=order.getOid()%>)" class="pri">付款</a> <br />
											
											 <a href="Javascript:void(0);"
												onclick="deleteCategoryById(<%=order.getOid()%>)"
												class="cancel">取消订单</a>
										</div>
									</td>
								</tr>
	...
	<div class="jiadian-bottom-one">
		<div class="w">
			<ol class="slogan">
				<li class="item-fore1"><i>多</i> <em>品类齐全,轻松购物</em></li>
				<li class="item-fore2"><i>快</i> <em>多仓直发,急速配送</em></li>
				<li class="item-fore3"><i>好</i> <em>正品行货,精致服务</em></li>
				<li class="item-fore4"><i>省</i> <em>天天低价,畅选无忧</em></li>
			</ol>
		</div>
		...
		<div class="w">
			<div class="last-title">
				<p class="last-title-p">
					<a href="#">关于我们</a> <span class="last-title-span">|</span> <a
						href="#">联系我们</a> <span class="last-title-span">|</span> <a
						href="#">联系客服</a> <span class="last-title-span">|</span> <a
						href="#">合作招商</a> <span class="last-title-span">|</span> <a
						href="#">商家帮助</a> <span class="last-title-span">|</span> <a
						href="#">营销中心</a> <span class="last-title-span">|</span> <a
						href="#">手机京东</a> <span class="last-title-span">|</span> <a
						href="#">友情链接</a> <span class="last-title-span">|</span> <a
						href="#">销售联盟</a> <span class="last-title-span">|</span> <a
						href="#">京东社区</a> <span class="last-title-span">|</span> <a
						href="#">风险监控</a> <span class="last-title-span">|</span> <a
						href="#">隐私政策</a> <span class="last-title-span">|</span> <a
						href="#">京东公益</a> <span class="last-title-span">|</span> <a
						href="#">English Site</a> <span class="last-title-span">|</span> <a
						href="#">Media & IR</a>
				</p>
			</div>
			...
			<div class="last-2">
				<p>
					<a href="#">京公网安备 11000002000088号</a> <span class="last-2-span">|</span>
					<span>京ICP证070359号</span> <span class="last-2-span">|</span> <a
						href="#">互联网药品信息服务资格证编号(京)-经营性-2014-0008</a> <span
						class="last-2-span">|</span> <span>新出发京零&nbsp;字第大120007号</span>
				</p>

				<p>
					<span>互联网出版许可证编号新出网证(京)字150号</span> <span class="last-2-span">|</span>
					<a href="#">出版物经营许可证</a> <span class="last-2-span">|</span> <a
						href="#">网络文化经营许可证京网文[2014]2148-348号</a> <span class="last-2-span">|</span>
					<span>违法和不良信息举报电话：4006561155</span>
				</p>

				<p>
					<span>Copyright © 2004 - 2018 京东JD.com 版权所有</span> <span
						class="last-2-span">|</span> <span>消费者维权热线：4006067733</span> <a
						href="#" style="margin-left: 10px;">经营证照</a> <span
						class="last-2-span">|</span> <span>(京)网械平台备字(2018)第00003号</span>
				</p>

				<p class="last-icno-cno">
					<a href="#"> <img src="img3/city-txt-1.png" /> <i>Global
							Site</i>
					</a> <span class="last-2-span">|</span> <a href="#"> <img
						src="img3/city-txt-2.png" /> <i>Сайт России</i>
					</a> <span class="last-2-span">|</span> <a href="#"> <img
						src="img3/city-txt-3.png" /> <i>Situs Indonesia</i>
					</a> <span class="last-2-span">|</span> <a href="#"> <img
						src="img3/city-txt-4.png" /> <i>Sitio de España</i>
					</a>
				</p>

				<p>
					<span>京东旗下网站：</span> <a href="#">京东钱包</a> <span class="last-2-span">|</span>
					<a href="#">京东云</a>
				</p>

				<p class="last-icno-bottom">
					<a href="" class="ac-1"></a> <a href="" class="ac-2"></a> <a
						href="" class="ac-3"></a> <a href="" class="ac-4"></a> <a href=""
						class="ac-5"></a> <a href="" class="ac-6"></a>
				</p>
			</div>
		</div>
	</div>
...
//第一行 地址
	...
	$(function() {
		...
		$(".con_div_search>input#search_inp").focus(function() {
...
<script type="text/javascript">
	function deleteCategoryById(id) {
		$.confirm({
			...
			content : '您确认要取消订单吗?',
			confirm : function() {
				location.assign("IndexActionServlet?action=deleteMyOrder&cid=" + id);
			},
			cancel : function() {
	...
	function payMentOneById(id){
		location.assign("IndexActionServlet?action=payment&cid=" + id);
	}
</script>
